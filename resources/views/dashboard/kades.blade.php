...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
    <div class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        ...
        <p class="mt-2 text-3xl font-bold text-blue-600">{{ $totalMenungguValidasi }}</p>
    </div>
    <div class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        <p class="text-sm text-slate-500">Disetujui Bulan Ini</p>
        <p class="mt-2 text-3xl font-bold text-emerald-600">{{ $totalDisetujuiBulanIni }}</p>
    </div>
    <div class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        <p class="text-sm text-slate-500">Ditolak Bulan Ini</p>
        <p class="mt-2 text-3xl font-bold text-red-600">{{ $totalDitolakBulanIni }}</p>
    </div>
</div>
